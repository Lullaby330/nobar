...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1001919971125"))
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "1001817200880"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "5818929389").split()):
        ADMINS.append(int(x))
except ValueError:
